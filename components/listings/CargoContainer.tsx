    ...
    const handleDeleteContainer = async (id: string) => {
        try {
            ...
            if (response.ok) {
                ...
                setContainers(containers.filter((container: { id: string; }) => container.id !== id));
            }
        } catch (error) {
            ...
            <div className="flex justify-between mb-4">
                ...
                {containers.length === 0 ? (
                    ...
                    <table className="table-auto w-full border-collapse border border-slate-400">
                        ...
                        <tbody>
                            {containers.map((container: { id: any; containerNumber: any; status: any; location: any; size?: string; type?: string; }) => (
                                <tr
                                    key={container.id}
